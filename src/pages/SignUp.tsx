...
function SignUp() {
    ...
    return (
        <>
            ...
            <Navbar></Navbar>
            <h1 className="font-semibold text-center mt-16 text-3xl">Create an account.</h1>
            <form onSubmit={createUser}>
                <label className="input input-bordered flex items-center gap-2 max-w-xs">
                    ...
                    <input type="text" name="email" id="email" placeholder="Email" className="grow" onChange={(e) => setEmail(e.target.value)} />
                </label>
                <label className="input input-bordered flex items-center gap-2 max-w-xs">
                    ...
                    <input type="password" name="password" id="password" placeholder="Password" className="grow" onChange={(e) => setPassword(e.target.value)} />
                </label>
